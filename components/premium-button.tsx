...
export const PremiumButton = () => {
    ...
    return (
        <a onClick={proModel.onOpen} className="relative inline-flex items-center justify-center w-full px-6 py-2 overflow-hidden text-white rounded-md shadow-2xl group">
